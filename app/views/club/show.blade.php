...
@section('container')
    <section class="show">
        <h2>Club de Vielsalm | <span>Province de Liège</span></h2>
        ...
        <div class="info">
            ...
            <div class="info">
                <ul>
                    <li><span>Entrainements:</span><span> 3xsemaine en soirée</span></li>
                    <li><span>Adresse:</span><span> Rue du tronc, 4309 Vielsalm</span></li>
                    <li><span>Cotisation:</span><span> 20€/mois</span></li>
